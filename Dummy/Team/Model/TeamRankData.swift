...
struct TeamRankWData: Codable {
    ...
    init(from decoder: Decoder) throws {
        ...
        rnk = try values.decodeIfPresent([TeamRnk].self, forKey: .rnk)
    }
...
struct TeamAwards: Codable {

    let rnk: Int?
    let a: [TeamAwardDetail]?
    ...
    init(from decoder: Decoder) throws {
        ...
        a = try values.decodeIfPresent([TeamAwardDetail].self, forKey: .a)
    }
...
struct TeamAwardDetail: Codable {
