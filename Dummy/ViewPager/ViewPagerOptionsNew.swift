...
public class ViewPagerOptionsNew {
    ...
    public var distribution: ViewPagerOptionsNew.Distribution = .normal
    ...
    public var isTabGradientAvailable:Bool = false
    public var isTabEdgesRoundedAvailable:Bool = false
    
    
    
    public var tabViewTopGradientColor:UIColor = Color.topGradient
    public var tabViewBottomGradientColor:UIColor = Color.botomGradient
    ...
    fileprivate struct Color {
        ...
        static let topGradient = UIColor   (red: 71 / 255.0, green: 85/255.0, blue: 134/255.0, alpha: 1.0)
        static let botomGradient = UIColor   (red: 12 / 255.0, green: 17/255.0, blue: 59/255.0, alpha: 1.0)
