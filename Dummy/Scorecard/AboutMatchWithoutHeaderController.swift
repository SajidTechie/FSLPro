//
//  AboutMatchWithoutHeaderController.swift
//  Dummy
//
...
class AboutMatchWithoutHeaderController: UIViewController {
...
extension AboutMatchWithoutHeaderController : ScorecardListPresentable {
